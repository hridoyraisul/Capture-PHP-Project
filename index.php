					...
					<!--	<div class="contact100-form-checkbox">
						...
						<div>
							<a href="registration.php" class="txt1">
								Click here if you're not registered yet
							</a>
						</div> 
					</div> 
...
$query = "SELECT username,password from users where username='".$_POST['username']."' AND password='".md5($_POST['password'])."' LIMIT 1";
