				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="home.php"><span>R</span><span>H</span></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 col-md-offset-0 text-center animate-box intro-heading">
						<span>Capture</span>
						<h2>Check out amazing photos</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="article animate-box">
							...
							<div class="desc">
								...
								<h2><a href="gallery.php">An Amazing High-way road</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">15, Feb 2018</span>
								<h2><a href="gallery.php">Wine Table</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">20, Sec 2016</span>
								<h2><a href="gallery.php">Tree</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">15, Jan 2017</span>
								<h2><a href="gallery.php">Plane</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">10, Mar 2019</span>
								<h2><a href="gallery.php">Kitchen</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">8, Feb 2019</span>
								<h2><a href="gallery.php">Wall</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">15, Feb 2014</span>
								<h2><a href="gallery.php">Home</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">22, Aug 2018</span>
								<h2><a href="gallery.php">Table</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
						...
						<div class="article animate-box">
							...
							<div class="desc">
								<span class="meta">13, Jan 2019</span>
								<h2><a href="gallery.php">Stair</a></h2>
								<p>Click the photo to share</p>
							</div>
						</div>
					</div>
